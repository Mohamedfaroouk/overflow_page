...
class _OverflowPageViewState extends State<OverflowPageView> {
  late Map<int, int> _pageItemCount;
  late bool _hasInvokedOnPageChangedForFirstPage;
  ...
  void _onPageChanged(int pageIndex) {
    ...
    final end = start + (_pageItemCount[pageIndex] ?? 0);
    widget.onPageChanged?.call(start, end);
  }
}
